...
const defAlias = {
  ...
  芒果猫: ['芒果', '芒果佬', '芒果猫佬'],
  喵喵: ['喵佬', '猫猫', '猫佬', '喵'],
  墨染希: ['墨染溪', '墨希染', '墨柒希', '小希', '希', '沃尔玛购物袋', '购物袋', '涩小希', '色小希'],
  娜娜: ['娜佬', '叨叨', 'nana', '兰迪娜', '女那女那', '金色娜娜', '萝莉控', '幼女控', '娜娜小萝莉', '可爱'],
  鸟图: ['鸟', '禽类', '禽图'],
  柠檬冲水: ['柠檬佬', '柠檬'],
  千羽: ['千羽酱', 'qianyu'],
  茄子: ['摇头茄子'],
  ...
  曉K: ['曉k', '晓K', '晓k', '小K','小k', 'K', 'k','K佬', 'k佬', '狗k', '狗K','萝莉k', '萝莉K', 'kk小萝莉', 'KK小萝莉', 'llk', 'lolik', 'SunRyK', 'sunryk', ' SmallK111407', 'smallk111407', 'SmallK', 'smallk', '🐶K', '🐶k'],
  椰羊: ['椰奶', '椰佬', '狗椰羊'],
  一生无悔: ['医生误会'],
