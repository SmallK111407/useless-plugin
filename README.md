...
发送`#随机杂图`可触发发送UNKNOWN文件夹中的随机一张图片，即未被分类的图片

发送`#随机乐子`可触发随机发送所有图片中的一张
...
发送`#全部<人物>`即可查看对应人物全部图片

**注意**:若该命令无效可能是因为优先级被覆盖，可尝试使用`#无用全部<人物>`
